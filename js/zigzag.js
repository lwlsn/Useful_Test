...
function zigzag(xVal) {
    ...
    if (!isNotHidden) {
        ...
        text("You can change the sounds of each sequencer by pressing the corresponding buttons.You can change also add effects by rotating the sliders.Clicking on the plus button in the bottom right hand corner allows you to add two different sequencers to play together.", xVal-xVal*(35/40)+10,350, 700, 500);
